...
//#define USE_BLYNK_WM          false
    ...
    String cloudBlynkServer = "192.168.1.59";
    #define BLYNK_SERVER_HARDWARE_PORT "9943/admin#"
    char ssid[] = "FIBRA_MOVISTAR_SMART_0822";
    char pass[] = "EAVJ500#*";
  #endif
#endif
  ...
  char auth[] = "t3IPulILyiFWg02oCi_eUiYu390p7FhP";
#endif
